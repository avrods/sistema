...
SECRET_KEY = 'django-insecure-+)zgt@a5(bcr8k9z=a!o1&g*zlbo$@*(5i_s3l+-_-1+n^ovu!'
...
LOGOUT_REDIRECT_URL = 'userApp:signin'
...
INSTALLED_APPS = [
    ...
    # Source Apps
    'source.systemApp.apps.SystemappConfig',
    'source.userApp.apps.UserappConfig',
    'source.webApp.apps.WebappConfig',
]
